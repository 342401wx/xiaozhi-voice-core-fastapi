# 小智语音核心 FastAPI 服务部署指南

本项目是从小智 ESP32 后端中提取出的语音问答核心服务，并新增了 FastAPI HTTP 接口。它可以提供：
...
```json
{
  ...
  "answer_text": "你好，我是一个可以进行语音问答的小智助手。",
...
4. 右上角选择环境 `Xiaozhi Voice Core Local`。
