...
export class AudioRecorder {
    ...
    updateInputLevel(buffer) {
        ...
        const rms = Math.sqrt(sumSquares / buffer.length) / 32768;
        this.lastInputLevel = Math.min(1, rms * 8);
        this.lastInputPeak = peak / 32768;
    ...
    getInputStats() {
        return {
            ...
            level: this.lastInputLevel,
            peak: this.lastInputPeak,
